...
An autoencoder consists of two parts, the encoder and the decoder, which can be defined as functions $f:X \rightarrow Y$ and $g:Y \rightarrow X$ where $dim X>dim Y$.
We want our autoencoder to be such that: $min |(f \circ g)(X)-X |^2$. It basically means that after using encoder and decoder our data is minimally changed.
